package com.eazybook.marcus.security;

import com.eazybook.marcus.filter.JWTTokenValidatorFilter;
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests((requests) -> {
                    ...
                    requests.requestMatchers("/eazybook/actuator/**").hasRole("OPS_ENG");
